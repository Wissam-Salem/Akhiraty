  ...
  return (
    <div className="relative">
      ...
      <div className="flex flex-col gap-5 mt-1">
        <div
          className="relative w-full h-60 flex justify-center items-center bg-[#51513D] text-white"
          dir="rtl"
        >
          <h1 className="start-hadith text-4xl max-sm:text-2xl">
            {" "}
            خَيْرُكُمْ مَن تَعَلَّمَ القُرْآنَ وعَلَّمَهُ.
          </h1>
          <p className="start-source absolute bottom-3 left-3">
            المصدر : صحيح البخاري
          </p>
        </div>
